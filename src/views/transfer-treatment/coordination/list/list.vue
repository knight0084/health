<template>
  <div class="transfer-treatment-coordination-list">
    <!-- form -->
    <div class="coordination-list-form">
      <Form ref="form"
            :mode="model"
            inline
            :label-width="75">
    ...
    <!-- table -->
    <div class="coordination-list-table">
      <Table stripe
             :data="coordination"
             :columns="columns"
             :loading="loading"/>
    ...
    <!-- pager -->
    <div class="coordination-list-pager">
      <Page :total="total"
            :current="pageNo"
            :page-size="pageSize"
            show-elevator
...
<script>
  export default {
    name: 'TransferTreatmentCoordinationList',
    data() {
      return {
        model: null,
        coordination: [],
    ...
    methods: {
      ...
      handleClickAdd() {
        this.$router.push({name: 'transfer-treatment-coordination-add'});
...
<style scoped lang="less">
  .transfer-treatment-coordination-list {
    ...
    // table
    .coordination-list-table {

    }

    // pager
    .coordination-list-pager {
      margin: 30px 0;
      text-align: right;
    }
